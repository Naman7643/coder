! function(e) {
        ...
        i.extendOptions(function() {
                for (var e = document.querySelectorAll('script[src*="embed.js"], script[src*="iframely.js"]'), t = 0; t < e.length; t++) {
                    ...
                    if (i.SCRIPT_RE.test(r)) {
                        var n = l(r, i.SUPPORTED_QUERY_STRING.concat("cdn", "cancel", "nonce")),
                            a = r.match(i.CDN_RE);
                        if ((a || n.cdn) && (i.CDN = n.cdn || a[1]), n.cancel && ("0" !== n.cancel && "false" !== n.cancel || (i.RECOVER_HREFS_ON_CANCEL = !0), delete n.cancel), Object.keys(n).length > 0) return n
                    }
                }
                return {}
            }()),
            function() {
                ...
                if (!e) {
                    ...
                    (e = document.createElement("style")).id = "iframely-styles", e.type = "text/css", o(e), e.styleSheet ? e.styleSheet.cssText = t : e.innerHTML = t, document.getElementsByTagName("head")[0].appendChild(e)
                }
            }(), i.config.theme && i.setTheme(i.config.theme),
            function(e) {
    ...
    var a = t.getIframeWrapper = function(e, t) {
        var r = e.parentNode;
        if (!(!r || "DIV" !== r.nodeName || c(r) > 2 || t && r.getAttribute("class") !== i.ASPECT_WRAPPER_CLASS || !t && "relative" !== r.style.position && r.getAttribute("class") !== i.ASPECT_WRAPPER_CLASS)) {
            var n = r.parentNode;
            if (!(!n || "DIV" !== n.nodeName || c(n) > 1 || t && n.getAttribute("class") && -1 === n.getAttribute("class").split(" ").indexOf(i.MAXWIDTH_WRAPPER_CLASS) || !t && n.getAttribute("class") && !n.getAttribute("class").match(/iframely/i))) return {
                aspectWrapper: r,
                maxWidthWrapper: n
            }
        }
    ...
    var o = t.applyNonce = function(e) {
        i.config.nonce && (e.nonce = i.config.nonce)
    };
    var d = t.addQueryString = function(e, t) {
        var r = "";
        return Object.keys(t).forEach((function(i) {
            ...
            if ("[object Array]" === Object.prototype.toString.call(n)) {
                ...
                r += "&" + a.join("&")
            } else void 0 !== n && -1 === e.indexOf(i + "=") && ("boolean" == typeof n && "_" !== i.charAt(0) && (n = n ? 1 : 0), r += "&" + i + "=" + encodeURIComponent(n))
    ...
    t.getEndpoint = function(e, t, r) {
        var n = e;
        if (/^(https?:)?\/\//i.test(e) || (n = (t.CDN || i.CDN) + n, delete t.CDN), /^(?:https?:)?\/\//i.test(n) || (n = "//" + n), t && (n = d(n, t)), r && r.length) {
            for (var a = {}, o = Object.keys(i.config), c = 0; c < o.length; c++) {
                var l = o[c];
                s(r, l) && (a[l] = i.config[l])
            }
            n = d(n, a)
        }
        return /^(https?:)?\/\//i.test(n) && !n.match(/^(https?:)?\/\//i)[1] && "http:" !== document.location.protocol && "https:" !== document.location.protocol && (n = "https:" + n), n
    ...
    var l = t.parseQueryString = function(e, t) {
        var r = e.match(/\?(.+)/i);
        if (r) {
    ...
    function o(e, t) {
        var r;
        return t.src && (r = a(e.querySelectorAll('iframe[src*="' + t.src.replace(/^https?:/, "") + '"]'), t.contentWindow)), r || (r = a(t.domains ? e.querySelectorAll('iframe[src*="' + (t.domains || i.DOMAINS).join('"], iframe[src*="') + '"]') : e.getElementsByTagName("iframe"), t.contentWindow)), r
    }
    i.findIframe || (i.findIframe = function(e) {
            var t = o(document, e);
            return t || (t = function e(t, r) {
                for (var n, a = "." + (i.config.shadow || i.SHADOW), d = t.querySelectorAll(a), c = 0; c < d.length && !n; c++) {
                    var s = d[c].shadowRoot;
                    s && ((n = o(s, r)) || (n = e(s, r)))
                }
                return n
            }(document, e)), t
        ...
        function(e) {
            function t(t) {
                var r;
                try {
                    "string" == typeof t.data ? r = JSON.parse(t.data) : "object" == typeof t.data && (r = t.data)
                } catch (e) {
                    if ("string" == typeof t.data) {
                        var i = t.data.match(/heightxPYMx(\d+)/);
                        i && (r = {
                            method: "resize",
                            height: parseInt(i[1]) + 1,
                            domains: "all"
                        })
                    }
                }
            ...
            if (t && (t.method || t.type || "player.js" === t.context)) {
                var r = i.findIframe({
                    contentWindow: e.source,
                    src: t.context,
                    domains: "all" !== t.domains && i.DOMAINS.concat(i.CDN)
                });
                if (r) {
                    var a = n.getWidget(r);
                    a && t.url && (a.url = t.url), i.trigger("message", a, t)
                }
            }
    ...
    var i, n = r(0);
    i = function() {
        void 0 !== n.config.autorun && !1 === n.config.autorun || n.trigger("load")
            ...
            r || (r = {
                ...
                function(e) {
                    ...
                    return r || (r = new IntersectionObserver((function(t) {
                        ...
                        e && e.margin && (t.rootMargin = e.margin + "px " + e.margin + "px " + e.margin + "px " + e.margin + "px");
                        return t
                    }(e)), a[t] = r), r
                }(r).observe(e.iframe)
        }
    ...
    function o(e, t) {
        for (var r = e.getElementsByTagName("iframe"), i = 0; i < r.length; i++) {
            a(r[i], t)
        }
    }
    i.setTheme = function(e, t) {
        e && i.SUPPORTED_THEMES.indexOf(e) > -1 ? t ? "IFRAME" === t.tagName ? a(t, e) : o(t, e) : (i.extendOptions({
            theme: e
        }), o(document, e), i.trigger("set-theme", e)) : console.warn('Using iframely.setTheme with not supported theme: "' + e + '". Supported themes are: ' + i.SUPPORTED_THEMES.join(", "))
    }
}, function(e, t, r) {
    var i = r(1),
        n = r(0),
    ...
    function o(e, t, r) {
        ...
        if (o) a = i.getWidget(t), n.cancelWidget(a || {
            ...
            var u, f;
            if ((a = document.createElement("div")).innerHTML = e.html, l && !s ? (u = l.aspectWrapper.parentNode, f = l.aspectWrapper, l.maxWidthWrapper.removeAttribute("style")) : (u = t.parentNode, f = t), d) {
                ...
                n.trigger("import-shadow-widget-before-render", g), u.insertBefore(p, f), n.trigger("import-shadow-widget-after-render", g)
            } else u.insertBefore(a, f),
                function e(t) {
                    function r(e) {
                    ...
                    var n, a, o, d = [],
                        c = t.childNodes;
                    for (o = 0; c[o]; o++) a = c[o], l = "script", !(s = a).nodeName || s.nodeName.toUpperCase() !== l.toUpperCase() || a.type && "text/javascript" !== a.type.toLowerCase() && "application/javascript" !== a.type.toLowerCase() ? e(a) : (d.push(a), t.removeChild(a));
                    var s, l;
                    for (o = 0; d[o]; o++)(n = d[o]).parentNode && n.parentNode.removeChild(n), r(d[o])
                }(a);
            u.removeChild(f), s && setTimeout((function() {
                c(u)
    ...
    function c(e) {
        for (var t = e, r = 0; t && (!t.getAttribute("class") || -1 === t.getAttribute("class").split(" ").indexOf(n.ASPECT_WRAPPER_CLASS));) t = t.parentNode, ++r > 4 && (t = null);
        var i = t && t.parentNode;
        i && i.getAttribute("class") && i.getAttribute("class").split(" ").indexOf(n.MAXWIDTH_WRAPPER_CLASS) > -1 && (t.removeAttribute("style"), t.removeAttribute("class"), i.removeAttribute("style"))
    }
            ...
            t.length > 1 && function(e) {
                ...
                function l(e) {
                    var t = e.getAttribute("data-iframely-url"),
                        ...
                        u = l.url;
                    delete l.url;
                    var f = "0" === l.import || "false" === l.import || "1" === l.playerjs || "true" === l.playerjs;
                    if (!f) {
                        var p = t.match(n.BASE_RE);
                        l.CDN = p && p[0], c ? JSON.stringify(l, Object.keys(l).sort()) !== JSON.stringify(c, Object.keys(c).sort()) && (f = !0) : c = l
                    }
                    if (f) n.trigger("load", e);
                    else if (d) e.setAttribute("data-import-uri", d), -1 === o.indexOf(d) && o.push(d), s(d, e);
                    else {
                        u || (u = e.getAttribute("href")), (c.key || c.api_key || n.config.api_key || n.config.key) && u ? (e.setAttribute("data-import-uri", u), -1 === r.indexOf(u) && r.push(u), s(u, e)) : n.trigger("load", e)
                    }
                }
                for (var u = 0; u < e.length; u++) {
                    var f = e[u];
                    !f.getAttribute("data-import-uri") && f.hasAttribute("data-iframely-url") && l(f)
                }
                r.length > 0 || o.length > 0 ? ((c = c || {}).touch = n.isTouch(), c.flash = function() {
                    ...
                    return e
                }(), c.app = 1, n.config.theme && (c.theme = n.config.theme), r.length > 0 && (c.uri = r), o.length > 0 && (c.ids = o.join("&")), c.v = n.VERSION, t.src = i.getEndpoint("/api/import/v2", c, n.SUPPORTED_QUERY_STRING), t.onerror = function() {
                    d()
    ...
    n.on("load", (function(e, t) {
        ...
        e && "A" === e.nodeName && (e.getAttribute("data-iframely-url") || e.getAttribute("href")) && !e.hasAttribute("data-import-uri") && function(e) {
            ...
            if (r && /^((?:https?:)?\/\/[^/]+)\/\w+/i.test(r)) t = i.getEndpoint(r, {
                v: n.VERSION,
                app: 1,
                theme: n.config.theme
            });
            else if ((n.config.api_key || n.config.key) && n.CDN) {
                if (!e.getAttribute("href")) return void console.warn('Iframely cannot build embeds: "href" attribute missing in', e);
                t = i.getEndpoint("/api/iframe", {
                    url: e.getAttribute("href"),
                    v: n.VERSION,
                    app: 1,
                    theme: n.config.theme
                }, n.SUPPORTED_QUERY_STRING)
            } else console.warn("Iframely cannot build embeds: api key is required as query-string of embed.js");
            if (t) {
                var a = document.createElement("iframe");
                a.setAttribute("allowfullscreen", ""), a.setAttribute("allow", "autoplay *; encrypted-media *; ch-prefers-color-scheme *"), e.hasAttribute("data-img") && a.setAttribute("data-img", e.getAttribute("data-img"));
                ...
                else c = i.addDefaultWrappers(e), e.parentNode.removeChild(e);
    ...
    n.on("load", (function(e) {
        if (e && "IFRAME" === e.nodeName && e.hasAttribute("data-iframely-url") && e.hasAttribute("data-img") && !e.getAttribute("src")) {
            ...
            e.removeAttribute("data-img"), e.setAttribute("data-img-created", "");
            var r = i.getWidget(e),
            ...
            ! function(e, t, r) {
                ...
                var u = n.getElementComputedStyle(e.aspectWrapper, "padding-top"),
                    f = n.getElementComputedStyle(e.aspectWrapper, "padding-bottom"),
                    p = u.match(/^(\d+)px$/);
                if (p && parseInt(p[1]) && f) {
    ...
    n.on("load", (function(e) {
        ...
        e && "IFRAME" === e.nodeName && e.hasAttribute("data-iframely-url") && !e.hasAttribute("data-img") && !e.getAttribute("src") && function(e) {
            var t = i.getWidget(e),
                ...
                a = e.hasAttribute("data-img-created") || e.hasAttribute("data-img"),
                o = !a && n.SUPPORT_IFRAME_LOADING_ATTR;
            if (t && r) {
                var d = {
                    v: n.VERSION,
                    app: 1,
                ...
                !o && n.config.intersection && (d.lazy = 1), r = i.getEndpoint(r, d)
            }
            o && e.setAttribute("loading", "lazy");
            a && n.SUPPORT_IFRAME_LOADING_ATTR && e.setAttribute("loading", "edge");
    ...
    var i = r(1),
        n = r(0);
    n.on("message", (function(e, t) {
        if ("setIframelyWidgetSize" === t.method || "resize" === t.method || "setIframelyEmbedData" === t.method || "embed-size" === t.type || "iframe.resize" === t.context) {
            var r = null;
    ...
    var i = r(0);
    i.widgets = i.widgets || {}, i.widgets.load = i.load, i.events || (i.events = {}, i.events.on = i.on, i.events.trigger = i.trigger), i.on("cancel", (function(e, t, r, n) {
        if (i.RECOVER_HREFS_ON_CANCEL && !r && (r = e), e && t && r && "" !== r) {
            var a = document.createElement("a");
            a.setAttribute("href", e), a.setAttribute("target", "_blank"), a.setAttribute("rel", "noopener"), a.textContent = r, n ? t.insertBefore(a, n) : t.appendChild(a)
        }
    }))
}, function(e, t, r) {
    var i, n = !!(i = navigator.userAgent.match(/Chrom(e|ium)\/([0-9]+)\./)) && parseInt(i[2], 10);
    r(0).SUPPORT_IFRAME_LOADING_ATTR = n && n >= 77
}, , , , , , , , , , , , function(e, t, r) {
    r(3);
    var i = r(0);
    i._loaded || (i._loaded = !0, r(4), r(5), r(7), r(8), r(9), r(10), r(11), r(12), r(13), r(14), r(15), r(16), r(17), r(18), i.trigger("init")), t.iframely = i
}]);