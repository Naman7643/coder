                ...
                for (var n = [], o = 0; o < r.length; o += 1) {
                    ...
                    if (0 !== i && 0 !== u) {
                        ...
                        if (s._defaultWidthX = p.defaultWidthX, s._nominalWidthX = p.nominalWidthX, 0 !== p.subrs) {
                            var c = eT(e, u + p.subrs + t);
                            s._subrs = c.objects, s._subrsBias = eS(s._subrs)
                        }
                        s._privateDict = p
                    }
                    n.push(s)
                    ...
                    for (var y, x, k, U, O, E, R, L, C, D, w, I, M = 0; M < l.length;) {
                        ...
                        switch (M += 1, G) {
                            ...
                            case 23:
                                ...
                                break;
                            case 4:
                                h.length > 1 && !d && (b = h.shift() + p, d = !0), m += h.pop(), S(v, m);
                                break;
                            case 5:
                            ...
                            case 12:
                                switch (G = l[M], M += 1, G) {
                                    ...
                                    case 36:
                                        ...
                                        break;
                                    case 37:
                                        a = v + h.shift(), n = m + h.shift(), o = a + h.shift(), s = n + h.shift(), R = o + h.shift(), L = s + h.shift(), C = R + h.shift(), D = L + h.shift(), w = C + h.shift(), I = D + h.shift(), Math.abs(w - v) > Math.abs(I - m) ? v = w + h.shift() : m = I + h.shift(), c.curveTo(a, n, o, s, R, L), c.curveTo(C, D, w, I, v, m);
                                        break;
                                    default:
            ...
            var eG = {
                    parse: function(e, t, r, a) {
                        ...
                        if (r.defaultWidthX = b.defaultWidthX, r.nominalWidthX = b.nominalWidthX, 0 !== b.subrs) {
                            var S = eT(e, x + b.subrs);
                            r.subrs = S.objects, r.subrsBias = eS(r.subrs)
                        ...
                        if (0 === d.encoding ? r.cffEncoding = new ed(el, T) : 1 === d.encoding ? r.cffEncoding = new ed(ep, T) : r.cffEncoding = function(e, t, r) {
                                var a, n = {},
                                    o = new es.Parser(e, t),
                                    s = o.parseCard8();
                                if (0 === s)
                                ...
                                return new ed(n, r)
                            }(e, t + d.encoding, T), r.encoding = r.encoding || r.cffEncoding, r.glyphs = new eb.GlyphSet(r), a.lowMemory) r._push = function(a) {
...
//# sourceMappingURL=64bbefcc-07681d1f4a56d80c.js.map