    ...
    [1153], {
        1153: function(e, o, t) {
            ...
            var h = {
                ...
                O = t(6057),
                S = t(17945),
                C = "0 0 0 0 rgba(0, 0, 0, 0.0)",
                j = (0, c.keyframes)(a || (a = (0, k.Z)(["\n  0% {\n    box-shadow: ", ";\n  }\n  7%,\n  60% {\n    box-shadow: var(--link-box-shadow);\n  }\n  100% {\n    box-shadow: ", ";\n  }\n"])), C, C),
                Z = (0, c.keyframes)(n || (n = (0, k.Z)(["\n  0% \n  100% {\n    box-shadow: ", ";\n  }\n"])), C),
                P = t(32371),
                W = {
                    "math-display": {
                        fontSize: "1.125em",
            ...
            var R = {
                ...
                Y = function(e) {
                    ...
                    return q(q(q(q(q(q(q({
                        height: "100%",
                        outlineWidth: "0px",
                        lineHeight: e ? "1.6 !important" : P.I0,
                        "--block-margin": (0, z.l1)(e),
                        ...
                        ".block-card": {
                            "&.expandable-node": {
                                "&-selected .expandable-selected": {
                                    animation: "".concat(j, " 3000ms ease-in-out forwards")
                                },
                        ...
                        "&.is-nested": {
                            display: "grid",
                            animation: "".concat(X, " ").concat(O.nY, "ms ease-out forwards")
                        },
                        "&.is-full-width": {
                            ".block.is-full-width": {
                    ...
                    }, P.g6), _.KX.default), E.E_.default), I.dE), W), {}, {
                        ".block-codeBlock": {
                            pre: {
                                fontFamily: "mono",
                        ...
                        }, (0, l.Z)(o, "&.is-focused, &:hover, &[".concat(S.r, "]"), {
                            ".gallery": {
                        ...
                        ".block-paragraph": (0, P.v0)("default"),
                        ".block-heading": q(q({}, (0, z.iL)(e).default), {}, {
                            ".heading": {
                                position: "relative"
                            },
                            '.heading[level="1"]': (0, P.v0)("h1"),
                            '.heading[level="2"]': (0, P.v0)("h2"),
                            '.heading[level="3"]': (0, P.v0)("h3"),
                            '.heading[level="4"]': (0, P.v0)("h4"),
                        ...
                        ".block-title": q(q({}, (0, z.iL)(e).default), {}, {
                            "&.is-focused-inside.is-empty": {
                                ".title": {
                                    "&[placeholder]::before": R
                                }
                        ...
                        ".node-gridLayout, .node-calloutBox, .node-smartLayoutCell": {
                            ".block-heading, .block-title": q({}, (0, z.iL)(e).compact),
                            ".block-paragraph": q({}, (0, z.YW)(e).compact)
                        },
                        ".block-table td": {
                            ".block": q({}, (0, z.YW)(e).tight),
                            ".block-heading, .block-title": q({}, (0, z.iL)(e).compact)
                        },
                ...
                G = (0, s.memo)(function() {
                    var e = (0, b.TZ)();
                    return (0, H.jsx)(c.Global, {
                        styles: function(o) {
                            var t, r = (t = {}, (0, l.Z)(t, ".".concat(p.pL), Y(e)), (0, l.Z)(t, ".".concat(p.vD), B), (0, l.Z)(t, ".".concat(F.G), y), (0, l.Z)(t, ".".concat(m.d), m.l), t);
                            if (r) return (0, d.iv)(r)(o)
                        }
                    })
                });
...
//# sourceMappingURL=1153-0aefc4240ff0ac01.js.map